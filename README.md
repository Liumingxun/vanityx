...
[@vanityx/cli]: ./packages/cli/README.md '@vanityx/cli'
[@vanityx/createx_guard]: ./packages/createx_guard/README.md '@vanityx/createx_guard'
[benchmark]: ./BENCHMARK.md 'vanityx benchmark'
